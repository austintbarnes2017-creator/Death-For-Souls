...
# signal door_started # UNUSED - preserved for future use
# signal gate_started # UNUSED - preserved for future use
# signal chest_started # UNUSED - preserved for future use
# signal lever_started # UNUSED - preserved for future use
...
# signal respawn_started # UNUSED - preserved for future use
